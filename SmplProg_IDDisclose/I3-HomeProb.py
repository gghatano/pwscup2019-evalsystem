...
Description: 
    ...
    It uses the fact that a user tends to be her home at 8:00-8:59.
    Specifically, it performs the following processes:
    1) Extract regions at 8:00-8:59 for both reference and anonymized traces.
    ...
    3) Re-identify each anonymized trace by choosing a user with the highest likelihood.
...
Usage:
    I3-HomeProb.py [Reference Trace (in)] [Anonymized Trace (in)] [Estimated Table (out)]
"""
import numpy as np
import math
import csv
